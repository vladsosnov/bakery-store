  ...
  return (
    <div style={pageStyles.wrapper}>
      <header style={pageStyles.header}>
        ...
        <div style={pageStyles.auth}>
          <button type="button" style={pageStyles.buttonGhost}>
                        Sign In
          </button>
      ...
      <main>
        ...
        <section style={{ ...pageStyles.section, ...pageStyles.cardsSection }}>
          ...
          <p style={{ maxWidth: '700px', color: '#76554a' }}>
                        We combine premium ingredients, old-school baking techniques, and modern
                        design so every cake, pastry, and loaf tastes incredible and looks perfect
                        for sharing.
          </p>
